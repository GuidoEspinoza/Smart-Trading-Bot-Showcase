...
This document defines the **Official Roadmap** for risk management and account growth.
The strategy acts as an initial "Booster" to capitalize small accounts, followed by a smooth transition to institutional capital preservation.

---

## 🗺️ Roadmap: The "Risk Glidepath"
...
## 💡 Why lower to 1%? (The Math of Ruin)

Maintaining 5% risk with $100,000 is suicidal:
*   **Risk 5% on $100k:** A streak of 4 losses = **-$20,000**. (Total Panic).
*   **Risk 1% on $100k:** A streak of 4 losses = **-$4,000**. (Manageable, just a bad day).

> **Approval:** This methodology aligns mathematical aggressiveness with human psychology needed for long-term success.

---

# Plan de Escalado y Crecimiento de Capital (Español) 🚀
